...
docker exec -t services /home/dac/recognize_html/speech2text.sh --plp-config /mnt/stp/recognize/$SYSTEM/conf/plp.conf --source-dir /mnt/stp/recognize/$SYSTEM/ --graph-dir /mnt/stp/recognize/$SYSTEM/graphs/$GRAPH $AUDIO $TEXT $RESULT
