...
#    600 data/train data/lang exp/tri3b_ali exp/ubm5a || exit 1;

#  steps/train_sgmm2.sh --cmd "$train_cmd" \
#    11000 25000 data/train data/lang exp/tri3b_ali \
#    exp/ubm5a/final.ubm exp/sgmm2_5a || exit 1;

#    utils/mkgraph.sh data/lang_test exp/sgmm2_5a exp/sgmm2_5a/graphs
#    steps/decode_sgmm2.sh --nj 10 --cmd "$decode_cmd" --transform-dir exp/tri3b/decode \
#      exp/sgmm2_5a/graphs data/test exp/sgmm2_5a/decode

#  steps/align_sgmm2.sh --nj 4 --cmd "$train_cmd" --transform-dir exp/tri3b_ali \
#    --use-graphs true --use-gselect true data/train data/lang exp/sgmm2_5a exp/sgmm2_5a_ali || exit 1;
#  steps/make_denlats_sgmm2.sh --nj 4 --sub-split 4 --cmd "$decode_cmd" --transform-dir exp/tri3b_ali \
#    data/train data/lang exp/sgmm2_5a_ali exp/sgmm2_5a_denlats

  steps/train_mmi_sgmm2.sh --cmd "$decode_cmd" --transform-dir exp/tri3b_ali --boost 0.1 \
    data/train data/lang exp/sgmm2_5a_ali exp/sgmm2_5a_denlats exp/sgmm2_5a_mmi_b0.1

  for iter in 1 2 3 4; do
    steps/decode_sgmm2_rescore.sh --cmd "$decode_cmd" --iter $iter \
      --transform-dir exp/tri3b/decode data/lang_test data/test exp/sgmm2_5a/decode \
      exp/sgmm2_5a_mmi_b0.1/decode_it$iter
  done

  steps/train_mmi_sgmm2.sh --cmd "$decode_cmd" --transform-dir exp/tri3b_ali --boost 0.1 \
   --drop-frames true data/train data/lang exp/sgmm2_5a_ali exp/sgmm2_5a_denlats exp/sgmm2_5a_mmi_b0.1_z

  for iter in 1 2 3 4; do
    steps/decode_sgmm2_rescore.sh --cmd "$decode_cmd" --iter $iter \
      --transform-dir exp/tri3b/decode data/lang_test data/test exp/sgmm2_5a/decode \
      exp/sgmm2_5a_mmi_b0.1_z/decode_it$iter
  done
