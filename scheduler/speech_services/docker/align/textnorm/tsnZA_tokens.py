...
SPECIAL_DICT_FILE = os.path.join(TEXTNORM_ROOT_DIR, "data", "tsnZA", "g2p.specialdict.txt")
ABBREVS_FILE = os.path.join(TEXTNORM_ROOT_DIR, "data", "tsnZA", "norm.abbrev.json")
VALID_GRAPHS_FILE = os.path.join(TEXTNORM_ROOT_DIR, "data", "tsnZA", "norm.graphset.txt")
...
UNK = "unk_unk"
#Punctuation expected around tokens and lowercase Tswana graphemes
VALID_PUNCTS = '".,:;!?(){}[]-'
