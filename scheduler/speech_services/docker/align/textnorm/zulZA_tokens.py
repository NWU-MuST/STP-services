...
SPECIAL_DICT_FILE = os.path.join(TEXTNORM_ROOT_DIR, "data", "zulZA", "g2p.specialdict.txt")
ABBREVS_FILE = os.path.join(TEXTNORM_ROOT_DIR, "data", "zulZA", "norm.abbrev.json")
VALID_GRAPHS_FILE = os.path.join(TEXTNORM_ROOT_DIR, "data", "zulZA", "norm.graphset.txt")
...
UNK = "unk_unk"
#Punctuation expected around tokens and lowercase Zulu graphemes
VALID_PUNCTS = '".,:;!?(){}[]-'
