...
#
# English gets a bad rap for having a lot of irregular verbs.  Sure,
# other languages may have fewer, but at least we can fit a pretty
# complete list of irregular verbs within this code.
#

# The subject verbs.
__irregular_present = {
      'do' : 'does', 'undo' : 'undoes', 'redo' : 'redoes',
      'go' : 'goes', 'forego' : 'foregoes' }
